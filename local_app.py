...
# Create Gradio interface
with gr.Blocks(title="Professional Document Converter") as demo:
    gr.Markdown("# Professional Document Converter")
    gr.Markdown("Convert documents from files or URLs to various formats")
    ...
    footer = """<div style="text-align: center; margin-top: 20px;"> 
        ...
        <a href="https://github.com/arad1367" target="_blank">My GitHub</a> | 
        <a href="https://arad1367.pythonanywhere.com/" target="_blank">Live demo of my PhD defense</a> | 
        <a href="https://github.com/DS4SD/docling" target="_blank">Docling project repo</a>
        <br> Made with 💖 by Pejman Ebrahimi
    </div>"""
    gr.HTML(footer)
